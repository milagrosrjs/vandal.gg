 ...
 */
const navbar = document.querySelector(".navbar"); // Cambiado a .navbar
const navToggler = document.querySelector("[data-nav-toggler]");
const navLinks = document.querySelectorAll("[data-nav-link]");

const toggleNav = function () {
  navbar.classList.toggle("active");
  navToggler.classList.toggle("active"); // Cambiado a navToggler
}
...
const hoverElements = [...document.querySelectorAll(".navbar-link"), ...document.querySelectorAll(".btn")]; // Cambiado a .navbar-link y .btn
